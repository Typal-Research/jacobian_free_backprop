...
from Networks import CIFAR10_FPN_Adjoint, BasicBlock
...
res_layers = 16
T       = CIFAR10_FPN_Adjoint(res_layers=res_layers, num_channels=35, contraction_factor=contraction_factor).to(device)
eps     = 1.0e-4
max_depth   = 50
