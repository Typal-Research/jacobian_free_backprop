...
from Networks import CIFAR10_FPN_Unaugmented_Adjoint, BasicBlock
...
res_layers = 1
T       = CIFAR10_FPN_Unaugmented_Adjoint(block=BasicBlock, num_blocks=num_blocks, res_layers=res_layers, num_channels=64, contraction_factor=contraction_factor).to(device)
eps     = 1.0e-1
max_depth   = 50
