...
from Networks import SVHN_FPN_Adjoint, BasicBlock
...
res_layers = 1
T       = SVHN_FPN_Adjoint(res_layers=res_layers, num_channels=64, contraction_factor=contraction_factor, block=BasicBlock, num_blocks=num_blocks).to(device)
eps         = 1.0e-4
max_depth   = 200
