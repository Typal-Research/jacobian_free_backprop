...
from Networks import MNIST_FPN_Jacobian_Based
...
res_layers = 1
T       = MNIST_FPN_Jacobian_Based(res_layers=res_layers, num_channels=32, contraction_factor=contraction_factor).to(device)
eps     = 1.0e-1
max_depth   = 50
...
print('max_iter_cg = ', max_iter_cg, ', max_depth = ', max_depth, 'cg_tol = ', tol_cg, ', eps = ', eps)
