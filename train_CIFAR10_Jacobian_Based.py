...
from Networks import CIFAR10_FPN_Jacobian_Based, BasicBlock
...
train_loader, test_loader = cifar_loaders(train_batch_size=batch_size, test_batch_size=400, augment=True)
...
res_layers = 16
T       = CIFAR10_FPN_Jacobian_Based(res_layers=res_layers, num_channels=35, contraction_factor=contraction_factor).to(device)
eps     = 1.0e-4
max_depth   = 50
...
print('max_iter_cg = ', max_iter_cg, ', max_depth = ', max_depth)
